...
export default function Header2({ playlists, lectures, qna_categories, activePlaylistId }) {
  ...
  return (
    <>
      {/* Top Bar */}
      <div className="bg-[#1a1f2e] text-white py-1.5 md:py-2 hidden lg:block">
        <div className="container max-w-[1260px] mx-auto px-3 sm:px-4 md:px-5 lg:px-6 xl:px-8">
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-3 md:space-x-4 lg:space-x-6 text-xs lg:text-sm">
        ...
        <AnimatePresence>
          {searchOpen && (
            <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: "auto", opacity: 1 }} exit={{ height: 0, opacity: 0 }}
              ...
              <div className="container max-w-[1260px] mx-auto px-3 sm:px-4 md:px-5 lg:px-6 py-3 lg:py-4">
